...
public class XianshiLogoChangjia extends Fragment {
	...
	private MyGridProductAdapter3 mAdapter;
	...
	private void init() {
		...
		mAdapter = new MyGridProductAdapter3(context, mList);
		imageLoader = mAdapter.imageLoader;
		options = mAdapter.options;
		page_up = 2;
	...
	private void loadButton(View mView) {
		...
		showRight = (ImageView) mView.findViewById(R.id.title_bar_publish);
				...
				.setOnRefreshListener(new OnRefreshListener2<ScrollView>() {
					...
					public void onPullUpToRefresh(
						...
						if (WebIsConnectUtil.showNetState(getActivity())) {
							productsManager.AsynGetLogoHasDialog(getActivity(),
									"0", page_up, "0");
							productsManager
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.setClass(getActivity().getBaseContext(),
						LogoItemListActivity.class);
				intent.putExtra("title", mList.get(arg2).getBrand());
...
//			String result = MyUtlis.readFiles(MyConstants.PRODUCT_LOGO,
//					getActivity());
			return DbProductManager.getInstance(context).getProductByCategory("logo");
		}
...
//		String ad = sp.getString("ad_brand", "");
//
//		adBeans = JsonParse.parseAdJson(ad);
		adBeans = DbAdManager.getInstance(context).getAdByCategory("ad_brand");
		mPullRefreshScrollView.scrollTo(0, 0);
		if (adBeans != null) {
