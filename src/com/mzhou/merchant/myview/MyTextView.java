...
textColor = attrs.getAttributeIntValue(namespace, "textColor", Color.GRAY);// 字体颜色
...
paintColor.setTextSize(25.0f);
paintColor.setColor(Color.GRAY);
}

public MyTextView(Context context, float textSize, int textColor, float paddingLeft, float paddingRight, float marginLeft, float marginRight) {
super(context);
...
if (textCharArray[i] > 127 && textCharArray[i] != '、' && textCharArray[i] != '，' && textCharArray[i] != '。' && textCharArray[i] != '：'
&& textCharArray[i] != '！') {
