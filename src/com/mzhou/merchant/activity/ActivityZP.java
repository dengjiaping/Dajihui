...
import com.mzhou.merchant.fragment.XianshiZhaoPing;
import com.mzhou.merchant.slidemenu.SlidingMenu;
import com.mzhou.merchant.utlis.MyUtlis;
 

public class ActivityZP extends FragmentActivity
{
	...
	protected void onCreate(Bundle arg0)
	{
		...
		setView();// TODO Auto-generated method stub
	...
	private void setView() {
		context = ActivityZP.this;
		mSlidingMenu = (SlidingMenu) findViewById(R.id.slidingMenu);
		if (mSlidingMenu.getChildCount() != 0) {
			mSlidingMenu.removeAllViews();
		}
		mSlidingMenu.setLeftView(getLayoutInflater().inflate(R.layout.frame_left, null));
		mSlidingMenu.setRightView(getLayoutInflater().inflate(R.layout.frame_right, null));
		mSlidingMenu.setCenterView(getLayoutInflater().inflate(R.layout.frame_center, null));
	...
	public static class ViewPageFragment extends Fragment
	{
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			pagerItemList.add(new XianshiZhaoPing());
