...
public class UserControlCompanyActivity extends Activity {
	...
	protected void onCreate(Bundle arg0) {
		...
		setContentView(R.layout.user_manager_company);
		Intent intent = getIntent();
		String string = intent.getStringExtra("company");
		...
		publish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				setResult(MyConstants.REQUEST_COMPANY, intent);
				finish();
			}
		});
	}
