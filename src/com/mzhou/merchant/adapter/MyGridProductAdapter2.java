 ...
 * 
 */
public class MyGridProductAdapter2 extends BaseAdapter {
...
//	public MyGridProductAdapter2(Context c, LinkedList<ProductsBean> mList,ImageLoader imageLoader,DisplayImageOptions options) {
	public MyGridProductAdapter2(Context c, LinkedList<ProductsBean> mList) {
		mContext = c;
		this.mList = mList;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = LayoutInflater.from(mContext).inflate(R.layout.item_grid2,
					null);
